...
Route::post('/update-student-groups', [StudentController::class, 'updateStudentGroups']);
//Route phân công
...
Route::post('/update-all-evaluations', [StudentController::class, 'updateAllEvaluations']);
