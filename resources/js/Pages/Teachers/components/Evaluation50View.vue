        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <button
                    v-if="canGrade50"
                    @click="openBulkModal"
                    class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold px-4 py-2 rounded-lg shadow-sm transition-all"
                >
                    Đánh giá sinh viên
                </button>
                        ...
                        <tr>
                            <th class="px-3 py-3 text-center w-10">
                                <input
                                    ...
                                    :disabled="!canGrade50"
                                    class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 disabled:opacity-50"
                                />
                            </th>
...
function submitBulkEvaluation() {
    if (bulkScore.value === "" && bulkNote.value === "") {
        alert("Vui lòng nhập điểm hoặc ghi chú!");
        return;
    }
