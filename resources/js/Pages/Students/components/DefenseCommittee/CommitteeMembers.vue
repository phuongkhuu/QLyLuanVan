    ...
    >
        <div class="px-6 py-5 border-b border-slate-200 bg-slate-50">
            ...
            >
                ...
                <div
                    class="px-4 py-2 rounded-xl bg-emerald-100 text-emerald-700 text-sm font-semibold"
                >
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="px-6 py-5">
                            <div
                                class="inline-flex px-4 py-2 rounded-2xl bg-slate-100 text-slate-700 text-sm font-medium"
                            >
                                {{ member.position }}
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-5">
                            <div
                                class="inline-flex px-4 py-2 rounded-2xl bg-blue-100 text-blue-700 text-sm font-semibold"
                            >
                                {{ member.department }}
                            </div>
                        </td>
