            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="px-6 py-5">
                            <p
                                class="text-sm text-slate-600 leading-relaxed max-w-xs"
                            >
                                {{ item.note }}
                            </p>
                        </td>
                        ...
                        <td class="px-6 py-5 text-center">
                            <div
                                ...
                                class="inline-flex items-center gap-2 px-4 py-2 rounded-2xl font-semibold text-sm"
                            >
                                {{ item.status }}
                            </div>
                        </td>
                        ...
                        <td colspan="6" class="py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-slate-500 text-sm mt-1">
                                    Hiện chưa có lịch phản biện nào được công bố
                                </p>
                            </div>
                        </td>
                    </tr>
